...
public class SoftwareEngineer
{
    ...
    public Dictionary<string, string[]> Skills { get; set; } = new()
    {
        ...
        { "Frontend", new[] { "HTML5", "CSS3", "JavaScript" } },
        { "Database", new[] { "SQL Server", "MySQL" } },
        { "Tools", new[] { "Git", "SQL Management Studio", "Visual Studio" } }
    };
...
![SSMS](https://img.shields.io/badge/SQL%20Management-CC2927?style=for-the-badge&logo=microsoft-sql-server&logoColor=white)
...
<div align="center">
  <img height="180em" src="https://github-readme-stats.vercel.app/api?username=Edwin-Jaret&show_icons=true&theme=tokyonight&include_all_commits=true&count_private=true"/>
...
<div align="center">
  <img src="https://komarev.com/ghpvc/?username=Edwin-Jaret&label=Profile%20views&color=0e75b6&style=flat" alt="Edwin-Jaret" />
</div>
